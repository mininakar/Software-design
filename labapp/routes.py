...
def index():
    ...
    return render_template('index2.html', title='Туры России.', pname='HOME', navmenu=controller.navmenu,
                            processed_files=processed_files)

# Обработка запроса к странице contact.html
@app.route('/contact')
def contact():
    return render_template('about.html', title='Туры россии.', pname='О проекте', navmenu=controller.navmenu)
